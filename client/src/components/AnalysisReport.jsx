...
//   const SERVER_URL = import.meta.env.VITE_SERVER_URL || 'https://gd-web-0cv6.onrender.com/';
...
export default function AnalysisReport({ roomId, userName, speakingTime, audioBlob, onClose }) {
  ...
  // --- BULLETPROOF FIX: Safely retrieve the server URL and strip trailing slash ---
  const getEnvUrl = () => {
    try {
      const env = Function('return import.meta.env')();
      return env.VITE_SERVER_URL || 'https://gd-web-0cv6.onrender.com';
    } catch (e) {
      return 'https://gd-web-0cv6.onrender.com';
    }
  };
  const RAW_SERVER_URL = getEnvUrl();
